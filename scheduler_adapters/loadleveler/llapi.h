...
/* static char sccsid[] = "@(#) src/ll/h/llapi.h, includes, comm_rsur2, rsur2s005a 1.29.1.8 6/13/11 01:44:25"; */
...
enum LLAPI_Specification {
	...
	RESERVED_LL_Step1,             /* reserved */
	RESERVED_LL_Step2,             /* reserved */
	RESERVED_LL_Step3,             /* reserved */
	...
	LL_MachineProvisionNode,     /* int * : privision type of this machine */
	...
	LL_ClassProvisionJob,	     /* int *: The boolean to specify whether or not this class is only to run provisioning jobs */
	...
	LL_ReservationProvisionFlag, /* int *: whether or not this provision is for a provision */
...
typedef struct {
	...
	int provision_flag;		/* whether or not the reservation is for a provisoin */
	char *machine_type;		/* reserve machine type */
}
...
#define RESERVATION_FORBIDDEN_RESERVE_MACHINE_TYPE_IN_NORMAL	-43 /* Cannot reserve with specified machinetype without -P is set */
/***********************************************************************
 ...
 **********************************************************************/
enum LL_config_op { CONFIG_I, CONFIG_C, CONFIG_D };
...
extern "C" {
	...
	int ll_config(int version, enum LL_config_op config_op, char **input, char ***output, char **hostlist, LL_element **err_obj);
#ifdef __cplusplus
}
#endif /* __cpluplus */
